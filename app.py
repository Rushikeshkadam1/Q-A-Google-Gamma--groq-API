...
from langchain.text_splitter import RecursiveCharacterTextSplitter # to convert text into chunks
from langchain.chains.combine_documents import create_stuff_documents_chain
from langchain_core.prompts import ChatPromptTemplate # to create own templates
